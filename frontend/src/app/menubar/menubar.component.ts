...
export class MenubarComponent implements OnInit {
  ...
  ngOnInit() {
   this.items = [
     ...
     {label: this.commonTranslationPipe.transform('Stock List', this.locale), icon: 'fa-table', routerLink: ['/stocks'], routerLinkActiveOptions: {'exact': 'true'}},
     {label: this.commonTranslationPipe.transform('Index List', this.locale), icon: 'fa-table', routerLink: ['/indices']},
     {label: this.commonTranslationPipe.transform('Stock screener', this.locale), icon: 'fa-search', routerLink: ['/stocks/search'], routerLinkActiveOptions: {'exact': 'true'}},
