...
parser.add_argument('--daily', dest='daily', action='store_true', help='load only daily fundamentals')
...
if daily:
    ...
    cur.execute("""SELECT * FROM vstock ORDER BY last_date_income NULLS FIRST""")
