...
insert into tindex (name, country_id)
    select 'MSCI Japan', country_id from tcountry where name = 'Japan' and 'MSCI Japan' not in (select name from tindex);
...
insert into tindex (name, country_id)
    select 'MSCI Japan Investable Market (IMI)', country_id from tcountry where name = 'Japan' and 'MSCI Japan Investable Market (IMI)' not in (select name from tindex);
...
insert into tindex (name, country_id)
    select 'MSCI Japan Small Cap', country_id from tcountry where name = 'Japan' and 'MSCI Japan Small Cap' not in (select name from tindex);
...
-- MSCI USA
insert into tindex (name, country_id)
    select 'MSCI USA', country_id from tcountry where name = 'USA' and 'MSCI USA' not in (select name from tindex);
...
-- MSCI USA Small Cap
insert into tindex (name, country_id)
    select 'MSCI USA Small Cap', country_id from tcountry where name = 'USA' and 'MSCI USA Small Cap' not in (select name from tindex);
...
-- MSCI Australia
insert into tindex (name, country_id)
    select 'MSCI Australia', country_id from tcountry where name = 'Australia' and 'MSCI Australia' not in (select name from tindex);
...
-- MSCI Brazil
insert into tindex (name, country_id)
    select 'MSCI Brazil', country_id from tcountry where name = 'Brazil' and 'MSCI Brazil' not in (select name from tindex);
...
-- MSCI Canada
insert into tindex (name, country_id)
    select 'MSCI Canada', country_id from tcountry where name = 'Canada' and 'MSCI Canada' not in (select name from tindex);
...
-- MSCI China
insert into tindex (name, country_id)
    select 'MSCI China inc Hong Kong', country_id from tcountry where name = 'China inc HK' and 'MSCI China' not in (select name from tindex);
...
-- MSCI France
insert into tindex (name, country_id)
    select 'MSCI France', country_id from tcountry where name = 'France' and 'MSCI France' not in (select name from tindex);
...
-- MSCI India
insert into tindex (name, country_id)
    select 'MSCI India', country_id from tcountry where name = 'India' and 'MSCI India' not in (select name from tindex);
...
-- MSCI Indonesia
insert into tindex (name, country_id)
    select 'MSCI Indonesia', country_id from tcountry where name = 'Indonesia' and 'MSCI Indonesia' not in (select name from tindex);
...
-- MSCI Italy
insert into tindex (name, country_id)
    select 'MSCI Italy', country_id from tcountry where name = 'Italy' and 'MSCI Italy' not in (select name from tindex);
...
-- MSCI Korea
insert into tindex (name, country_id)
    select 'MSCI Korea', country_id from tcountry where name = 'Korea' and 'MSCI Korea' not in (select name from tindex);
...
-- MSCI Malaysia
insert into tindex (name, country_id)
    select 'MSCI Malaysia', country_id from tcountry where name = 'Malaysia' and 'MSCI Malaysia' not in (select name from tindex);
...
-- MSCI Mexico
insert into tindex (name, country_id)
    select 'MSCI Mexico', country_id from tcountry where name = 'Mexico' and 'MSCI Mexico' not in (select name from tindex);
...
-- MSCI Poland
insert into tindex (name, country_id)
    select 'MSCI Poland', country_id from tcountry where name = 'Poland' and 'MSCI Poland' not in (select name from tindex);
...
-- MSCI Russia
insert into tindex (name, country_id)
    select 'MSCI Russia', country_id from tcountry where name = 'Russia' and 'MSCI Russia' not in (select name from tindex);
...
-- MSCI Singapore
insert into tindex (name, country_id)
    select 'MSCI Singapore', country_id from tcountry where name = 'Singapore' and 'MSCI Singapore' not in (select name from tindex);
...
-- MSCI South Africa
insert into tindex (name, country_id)
    select 'MSCI South Africa', country_id from tcountry where name = 'South Africa' and 'MSCI South Africa' not in (select name from tindex);
...
-- MSCI Spain
insert into tindex (name, country_id)
    select 'MSCI Spain', country_id from tcountry where name = 'Spain' and 'MSCI Spain' not in (select name from tindex);
...
-- MSCI Switzerland
insert into tindex (name, country_id)
    select 'MSCI Switzerland', country_id from tcountry where name = 'Switzerland' and 'MSCI Switzerland' not in (select name from tindex);
...
-- MSCI Taiwan
insert into tindex (name, country_id)
    select 'MSCI Taiwan', country_id from tcountry where name = 'Taiwan' and 'MSCI Taiwan' not in (select name from tindex);
...
-- MSCI Turkey
insert into tindex (name, country_id)
    select 'MSCI Turkey', country_id from tcountry where name = 'Turkey' and 'MSCI Turkey' not in (select name from tindex);
